...
Organizations are not static entities. They change their names, merge, split, shut down, and re-emerge. This makes it difficult to connect research organizations to research outputs and researchers. A persistent identifier for research organizations makes this easier.
...
Looking for basic information about ROR? Check out the [[frequently asked questions](https://docs.google.com/document/d/1219SGJj3m4NU6oOpYBEfarQpxdZAz4vsdN1MOgw1ILE/edit#)](/faqs). 

{{% /callout %}}

## Governance model

ROR is operated as a collaborative initiative by [California Digital Library](https://cdlib.org), [Crossref](https://crossref.org), and [DataCite](https://datacite.org). The three ROR governing organizations collectively assume and share responsibility for ROR governance, operations, resourcing, and decision-making. These responsibilities are defined in a Memorandum of Agreement (MOA).
...
ROR's three governing organizations share collective responsibility for operating ROR and commit in-kind support to cover ROR's core personnel and operating expenses. Beginning in 2023, ROR staffing and core expenses will be supported entirely by the three ROR governing organizations per the terms of their Memorandum of Agreement.
...
In line with ROR's commitment to the [Principles of Open Scholarly Infrastructure](https://openscholarlyinfrastructure.org) (POSI), ROR will not only use time-limited funds for time-limited projects, and any potential revenue-generation models would be based on services, not data.

## Team

### Operations team

The ROR operations team comprises the ROR project lead and directors of each governing organization and is responsible for strategic decision-making about registry resourcing and operations.

- Maria Gould, Project Lead (California Digital Library)
...
The MVR and first registry release included ROR IDs and metadata for 91,625 organizations and was built from the seed data from GRID. The MVR also included mechanisms for accessing and querying ROR data via a search interface, REST API, and data dump. 

### Startup years (2019--2022)
...
ROR's [Community Advisory Group](/community#community-advisory-group) was established in March 2019 and has met bimonthly since then.

[Dryad became the first ROR adopter](https://ror.org/blog/2019-07-10-ror-ing-together-with-dryad/) in July 2019.

DataCite began [supporting ROR IDs in its DOI metadata schema](https://doi.org/10.5438/vgaq-ar22) in August 2019.

ROR [kicked off a community fundraising campaign](https://ror.org/blog/2019-10-16-help-sustain-ror/) in October 2019 that has raised $XXX,XXX to date from [supporters around the world](/community#supporters).

ROR's [inaugural Steering Group](https://ror.org/blog/2019-11-22-meet-the-ror-steering-group/) was established in November 2019.
...
ROR became one of the first adopters of the [Principles of Open Scholarly Infrastructure](https://ror.org/blog/2020-12-16-aligning-ror-with-posi/) in December 2020.

In July 2021, GRID [announced plans to sunset its public data and officially pass the torch to ROR](https://ror.org/blog/2021-07-12-ror-grid-the-way-forward/).
...
ROR published its [first independent registry update](https://ror.org/blog/2022-03-17-first-independent-release/) in March 2022.
