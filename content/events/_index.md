...
{{% button color="green" link="https://crossref.zoom.us/meeting/register/tJIocOqtrD8iGdcasXoLLemOsbn9dij-UtP2" %}} Register for the October ROR Open Hours - 1st Wednesdays {{% /button %}}
...
{{% button color="green" link="https://crossref.zoom.us/meeting/register/tJ0tcuqhpjwrGt28wRU5EJrLPvXnjKA7WvMv" %}} Register for the October ROR Open Hours - 2nd Thursdays {{% /button %}}
