...
location = "Online"
recorded = "Yes"
description = "In the ROR Community Call for July 2024, we hear initial thoughts on adding credentialing to the ROR API, request feedback on a proposal to add additional external identifiers to ROR records, learn about new ROR adoptions, notably DSpace 8, and see presentations from featured integrators [American Physical Society (APS)](https://aps.org) and [Curvenote](https://curvenote.com)."
website = ""
reglink = ""
+++
