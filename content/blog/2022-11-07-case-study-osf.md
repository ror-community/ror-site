...
{{< figure src="/img/blog/osf/cos-osf-infrastructure.png" class="blog-figure" alt="Pyramid schematic with five levels in the following order from bottom to top: infrastructure, user experience, communities, incentives, and policy. Also shown is the COS Infratructure vision statement: To empower communities, institutions, and funders to advance rigor and transparency of research." >}}
