+++ 
title = "Three Tips for Requesting a New ROR ID" 
date = "2026-06-24T14:52:59-04:00"
draft = false 
tags = ["Curation"] 
...
thumb = "/img/blog/three-tips/three-tips.png" 
...
{{< figure src="/img/blog/three-tips/three-tips.png" class="featured-figure" alt="Three tips for requesting a new ROR ID." >}}
...
{{< youtube id="DJtmDdqNFic" class="blog-video" >}}
...
ROR has a web-based search tool that makes it simple to find the ROR ID for an organization, if it exists. The search box is embedded on our home page at [https://ror.org](https://ror.org) and is also available at [https://ror.org/search](https://ror.org/search).

{{< figure src="/img/blog/three-tips/ror-web-search-zulia.gif" alt="GIF of searching ROR." caption="Searching ROR shows that there is an [existing record for the Universidad del Zulia](https://ror.org/04vy5s568), so there is no need to [ask us to add a new record to ROR for the organization](https://github.com/ror-community/ror-updates/issues/30355)." >}}
...
{{< figure src="/img/blog/three-tips/provide-dois.png" alt="ROR request form with 3 DOIs." caption="Example of links to reputable research outputs that acknowledge the organization as a funder, publisher, or affiliation of an author / creator / contributor." >}}
...
Still not sure about the process? You can email us at [support@ror.org](mailto:support@ror.org) with any questions, and we'll be happy to advise you.
