...
To supplement this baseline resourcing, ROR continues to receive outside investment by stakeholder organizations. These additional funds allow ROR to accelerate and scale our work and activities, and to invest in strategic time-limited projects. Community funding also showcases the importance of investing in core open infrastructure that all can benefit from regardless of their ability to pay for it - not unlike the public radio model in the United States.

### ROR as core infrastructure for other core infrastructure: The example of ORCID 
...
-   [French Open Science Office](https://www.ouvrirlascience.fr/) (France)
...
ROR is also a key component of each of its governing organization's strategic objectives. ROR was identified by Crossref members as a top priority back in 2019, and ROR IDs play an important role in Crossref's vision of the research nexus and its aims to make scholarly information easier to find, assess, and connect. For DataCite's straegic focus on identifying and connecting knowledge, ROR IDs are key to establishing connections in DOI metadata to enable meaningful insights about how research is conducted and used. For CDL, investing in open metadata for affiliations aligns with the University of California's goals to make UC research - including the underlying metadata - more openly available. For example, identifying UC research to be made openly available requires accurate identification of UC-affiliated authors.

### Why invest in open scholarly infrastructure?
...
We are grategul to all of the organizations that have been supporting ROR in one way or another over the years, and in the years to come.