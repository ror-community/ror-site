...
{{< figure src="/img/blog/use-case-funders/datacite-funder-ids-by-type.png" alt="Funder identifiers by ID type in DataCite"  caption="DataCite records that have a value in ```fundingReferences.funderIdentifier``` as of July 15, 2024, broken down by ```fundingReferences.funderIdentifier.Type```. See [ROR DOI stats](https://docs.google.com/spreadsheets/d/e/2PACX-1vQU_zvKDRXOFY56Zq6gAZyWBXWivQxPyDgAVP18bYDpNTgrM2pQFz4EzNc6I44kgTmhoVqkTJfef-HN/pubhtml) spreadsheet for queries and data." >}}
