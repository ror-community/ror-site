...
**In the majority of cases, these core facilities are not in scope for ROR because they are subsections or service offerings at a university instead of being functionally separate organizations in the way that hospitals, national laboratories and facilities, or large research institutes are.** Core facilities offer researchers access to resources such as large instruments, and the researchers who use the core facility often acknowledge this contribution in their published research outputs, as explained above, but the researchers do not give the core facility as an affiliation when they publish datasets and/or journal articles. The national or international facilities that have ROR IDs are also acknowledged by researchers in this way (and they may well also be core facilities), but the organizations in ROR are also often used as primary researcher affiliations. 

The difference between facility acknowledgement and author affiliation can be seen by looking at a sample article [published in 2022 in the journal *Leukemia* by Baeten et al.](https://doi.org/10.1038/s41375-021-01491-z) The authors are affiliated with research organizations that can be identified by ROR IDs, including The University of Chicago Medicine Comprehensive Cancer Center ([https://ror.org/042wftp98](https://ror.org/042wftp98)).  
...
In short, then, **RRIDs are best used to help track facility acknowledgements, while ROR IDs are best used to help track contributor affiliations.** That being said, ROR IDs can also be used to help track facility acknowledgements if the facility has a ROR ID.  
