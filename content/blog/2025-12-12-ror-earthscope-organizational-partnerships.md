...
{{< figure src="/img/blog/earthscope/partnerships-chart.png" class="featured-figure" alt="Chart of partnerships between the EarthScope Consortium and other organizations.">}}
...
[DataCite](https://datacite.org) now has over 1,700 members and, as the membership expands, different types of organizations join the DataCite community. Some of these new members are organizations with important partnerships with other organizations. The DataCite [metadata schema](https://schema.datacite.org/) for DOIs includes the capability to define [a type for creators and contributors](https://datacite-metadata-schema.readthedocs.io/en/4.5/properties/creator/#a-nametype) which can be Personal (default) or Organizational. Personal creators and contributors are typically identified with [ORCID](https://orcid.org) iDs, of course, whereas Organizational creators and contributors are identified with ROR IDs. 
...
{{< figure src="/img/blog/earthscope/datacite-commons.png" alt="Side by side screenshots." caption="Figure 1. DataCite Commons pages from EarthScope (left) and Princeton (right) that show ShakeMovies created by Princeton in the EarthScope repository." >}}
...
In a sample of 10,000 records with organizational creators from each of these repositories, the Distributed System of Scientific Collections ([DiSSCo](https://www.dissco.eu/)) is the only one besides the SAGE repository that includes identifiers for their organizational creators. The most common creator ROR ID in DiSSCO ([https://ror.org/0566bfb96](https://ror.org/0566bfb96)) identifies the Naturalis Biodiversity Center, a biodiversity museum in The Netherlands that coordinates closely with DiSSCo. The [DataCite Commons page for The Naturalis Biodiversity Center](https://commons.datacite.org/ror.org/0566bfb96) currently shows 7,036,619 works associated with this ROR ID, with 99% of them created in a major expansion of the DiSSCo repository during 2025. This is a clear bright spot that uses ROR IDs effectively to recognize their partners!

| **Repository Name** | **DataCite Repository ID** | **Number of Records in Repository** |
| --- | --- | --- |
| [Distributed System of Scientific Collections (DiSSCo)](https://commons.datacite.org/repositories/zr3cyxn) | ylqb.ybhfwy | 7,036,619 |
| [Global Biodiversity Information Facility](https://commons.datacite.org/repositories/4ygcg72) | gbif.gbif | 4,108,688 |
| [International Treaty on Plant Genetic Resources for Food and Agriculture](https://commons.datacite.org/repositories/3znc71) | fao.itpgrfa | 1,911,979 |
| [Genebank Information System of the IPK Gatersleben](https://commons.datacite.org/repositories/or2c5dv) | ipk.gbis | 209,708 |
| [Plutof. Data Management and Publishing Platform](https://commons.datacite.org/repositories/y79cxl) | estdoi.bio | 3,201,243 |
| [Leibniz-Institut für Astrophysik Potsdam (AIP)](https://commons.datacite.org/repositories/k6qcx2) | tib.aip | 279,264 |
| [HEPData](https://commons.datacite.org/repositories/6eycrn) | cern.hepdata | 177,346 |
| [TERN IGSN ID Catalogue](https://commons.datacite.org/repositories/y79c166) | tern.igsn | 130,741 |
| [Hochschularchiv SRP](https://commons.datacite.org/repositories/wqjcn8j) | stdp.jwqddo | 124,452 |
| [NSF Seismological Facility for the Advancement of Geoscience (SAGE)](https://commons.datacite.org/repositories/rv5cenq) | iris.iris | 117,674 |
