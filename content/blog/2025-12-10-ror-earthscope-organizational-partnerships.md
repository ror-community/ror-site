...
For example, the [Global CMT Project](https://www.globalcmt.org/) calculates Centroid Moment Tensors that give key source parameters like magnitudes, fault orientations, and locations for earthquakes all over the world while [Global Shake Movies](https://global.shakemovie.princeton.edu/) generated by Princeton University and given DataCite DOIs are used to visualize ground motion as seismic waves travel around the world.


{{< figure src="/img/blog/earthscope/shakemovie.png" caption="Still image from a Global ShakeMovie for an earthquake in Myanmar, [https://doi.org/10.17611/dp/23119472](https://doi.org/10.17611/dp/23119472)" >}}
