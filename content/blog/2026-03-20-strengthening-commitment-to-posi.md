...
Since its founding, ROR has been committed to providing open infrastructure for the global community. As part of this commitment, in December 2020, ROR released a [public self-assessment](/blog/2020-12-16-aligning-ror-with-posi/) of our alignment with the [Principles of Open Scholarly Infrastructure](https://openscholarlyinfrastructure.org/) (POSI). 

At the time, the POSI framework, originally articulated in 2015, had been [recently (re)codified](https://openscholarlyinfrastructure.org/posi-v1.0/) as a set of concrete guidelines, inspiring a small [group](https://openscholarlyinfrastructure.org/adopters/) of open scholarly infrastructure initiatives to assess how they were aligned with these principles. 
